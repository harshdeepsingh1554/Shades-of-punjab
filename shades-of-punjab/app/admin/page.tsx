...
import { Package, PlusCircle, LogOut, Loader2, Crown, Shirt, Camera } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-royal-dark text-royal-cream p-6 flex flex-col items-center relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl w-full relative z-10">
        ...
        <Link href="/admin/custom-requests" className="group relative bg-[#1a1510] border border-royal-gold/30 p-10 rounded-xl hover:border-royal-gold hover:bg-[#251d16] transition-all duration-500 shadow-lg hover:shadow-royal-gold/20 text-center overflow-hidden">
          {/* Hover Effect Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-royal-gold/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"/>
