...
export default function CustomRequest() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#2a0a12] to-[#0f0505] flex items-center justify-center p-4 relative overflow-hidden">
      
      {/* Decorative Glows */}
      <div className="absolute top-[-20%] left-[-20%] w-[500px] h-[500px] bg-[#c5a059] rounded-full blur-[150px] opacity-10 pointer-events-none"></div>
      <div className="absolute bottom-[-20%] right-[-20%] w-[500px] h-[500px] bg-[#2a0a12] rounded-full blur-[150px] opacity-30 pointer-events-none"></div>

      <div className="max-w-xl w-full bg-[#1a1510] border border-[#c5a059]/30 rounded-2xl shadow-2xl p-6 md:p-8 relative z-10">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="bg-[#0f0505] border border-[#c5a059]/30 rounded-xl p-3 focus-within:border-[#c5a059] transition-colors">
              <textarea 
          ...
          <div>
            ...
            <div className={`border-2 border-dashed rounded-xl p-8 text-center transition-all duration-300 cursor-pointer relative group flex flex-col items-center justify-center
